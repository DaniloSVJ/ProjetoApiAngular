...
namespace ProjetoAPIAngular.Controllers
{
    ...
    public class PessoasController : Controller
    {
        ...
        public IEnumerable<Pessoa> GetPessoas()
        {
           ...
           {
               new Pessoa(){Id = 1, Nome = "Hugo Vasconcelos", DataNascimento = new DateTime(1900, 1, 2)},
               new Pessoa(){Id = 2, Nome = "Fábio Vasconcelos", DataNascimento = new DateTime(1900, 1, 2)}
           };
        }
